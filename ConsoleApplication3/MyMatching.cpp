...
void MyMatching::drawOriKeypointOnImg(char* _filenameA, char* _filenameB, char* _saveAddrA, char* _saveAddrB) {
	...
	//展示画出图像并保持，且后期可以不进行运算叠加，仅仅拿来画图展示
